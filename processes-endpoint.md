...
The files are grouped by the metadata field "dspace.process.filetype", the type can be anything it refers to what the file represents, is it a mapping file, an exported csv file, ...
```json
{
  "processId" : "4",
  "_embedded": {
