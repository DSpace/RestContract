...
Multipart POST currently support two different mode:
...
**Import from file**  
In this scenario, all works in the same way as "remote resource", but user submits one or more file(s) instead of remote resource id.
