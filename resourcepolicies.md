...
Sample CURL command:
```
curl -i -X POST 'https://api7.dspace.org/server/api/authz/resourcepolicies/3/eperson' -H 'Authorization: Bearer eyJhbGciOiJ…' -H "Content-Type:text/uri-list" --data 'https://dspace7-entities.atmire.com/rest/api/eperson/epersons/ba05e3dd-aa20-4441-ac05-8ceef6f67ac7'
```
...
Sample CURL command:
```
curl -i -X POST 'https://api7.dspace.org/server/api/authz/resourcepolicies/4/group' -H 'Authorization: Bearer eyJhbGciOiJ…' -H "Content-Type:text/uri-list" --data 'https://dspace7-entities.atmire.com/rest/api/eperson/groups/db337ae5-abd2-4a28-b4ad-918cf7779e25'
```
